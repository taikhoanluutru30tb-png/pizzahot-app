...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: "Create Order", href: "/ctv/create-order", icon: PlusSquare },
  { label: "Order", href: "/ctv/order", icon: ClipboardList },
  { label: "Message", href: "/ctv/message", icon: MessageSquareText },
  { label: "User Profile", href: "/ctv/profile", icon: UserRound },
];
...
export default function CtvLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#fff7f5] text-[#4f342f] lg:pl-[286px]">
      <aside className="fixed inset-y-0 left-0 hidden w-[286px] flex-col border-r border-[#2d0909] bg-[#0b0b0b] px-5 py-6 text-white shadow-[10px_0_40px_rgba(0,0,0,0.22)] lg:flex">
        ...
        <div className="mt-6 rounded-[24px] bg-[#121212] p-4 shadow-inner shadow-black/30 ring-1 ring-white/5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-sm text-[#9f817d]">Quản lý viên</div>
            </div>
          </div>
      ...
      <header className="sticky top-0 z-40 border-b border-[#eddcda] bg-white/95 backdrop-blur lg:hidden">
        <div className="flex items-center justify-between gap-3 px-4 py-3">
          ...
          <Link
            href="/ctv/profile"
            className="grid h-11 w-11 place-items-center rounded-2xl bg-[#fff3f2] text-[#dc2626]"
            aria-label="Profile"
          >
        ...
        {mobileMenuOpen ? (
          <div className="border-t border-[#eddcda] bg-white px-3 py-3 shadow-lg">
